...
public class SampleActivity extends Activity {
    ...
    //Change to ENVIRONMENT_PRODUCTION for Live---------------------------------------------------------------------------------
    private static final String CONFIG_ENVIRONMENT = PayPalConfiguration.ENVIRONMENT_SANDBOX;

    // note that these credentials will differ between live & sandbox environments.
    //Change to the Live ID ---------------------------------------------------------------------------------
    private static final String CONFIG_CLIENT_ID = "AbX9phCdxfsmNQpVm0303D7EOHT_tQVhE3xN9L-iV8tyYcoVcwh2krBzhESt"/*"credential from developer.paypal.com"*/;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_pay = (EditText)findViewById(R.id.edit_transfer);
        edit_msg = (EditText)findViewById(R.id.edit_message);
        btn_send =  (Button)findViewById(R.id.btn_submit);
        txt = (TextView)findViewById(R.id.txt_click_here);
        ...
        txt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// Y B Black R
		        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SampleActivity.this);
		        
		        // Setting Dialog Title
		        alertDialog.setTitle("Canadian Donors:");
		 
		        // Setting Dialog Message
		        alertDialog.setMessage("Make ckecks out to 'GNTCA'\n ABN Inc.\n P.O. Box 34085\n 446 Holland Trail\n Aurora ON, L4G7T6 Canada");
    ...
    private PayPalPayment getThingToBuy(String paymentIntent) {
        return new PayPalPayment(new BigDecimal(edit_pay.getText().toString()), "USD", "Donation",
                paymentIntent);
    }
	...
	public boolean isConnectingToInternet() {
		ConnectivityManager connectivity = (ConnectivityManager) SampleActivity.this
