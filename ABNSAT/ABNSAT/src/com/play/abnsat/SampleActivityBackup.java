 ...
 */
public class SampleActivityBackup extends Activity {
    ...
    public void onBuyPressed(View pressed) {
        ...
        Intent intent = new Intent(SampleActivityBackup.this, PaymentActivity.class);
    ...
    public void onFuturePaymentPressed(View pressed) {
        Intent intent = new Intent(SampleActivityBackup.this, PayPalFuturePaymentActivity.class);

        startActivityForResult(intent, REQUEST_CODE_FUTURE_PAYMENT);
    }

    public void onProfileSharingPressed(View pressed) {
        Intent intent = new Intent(SampleActivityBackup.this, PayPalProfileSharingActivity.class);
